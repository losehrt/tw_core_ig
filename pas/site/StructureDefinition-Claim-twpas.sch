...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim">
      <sch:assert test="count(f:extension[@url = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-claim-encounter']) &gt;= 1">extension with URL = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-claim-encounter': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-claim-encounter']) &lt;= 1">extension with URL = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-claim-encounter': maximum cardinality of 'extension' is 1</sch:assert>
  ...
  <sch:pattern>
    <sch:title>f:Claim/f:supportingInfo/f:value[x] 1</sch:title>
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Claim/f:item">
      <sch:assert test="count(f:extension[@url = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-requestedService']) &gt;= 1">extension with URL = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-requestedService': minimum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:extension[@url = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-requestedService']) &lt;= 1">extension with URL = 'https://nhicore.nhi.gov.tw/pas/StructureDefinition/extension-requestedService': maximum cardinality of 'extension' is 1</sch:assert>
      <sch:assert test="count(f:programCode) &gt;= 1">programCode: minimum cardinality of 'programCode' is 1</sch:assert>
